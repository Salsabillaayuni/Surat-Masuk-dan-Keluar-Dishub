...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
	<a href="#" data-toggle="modal" data-target="#tambahdisposisi" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data </a>
		...
		<span class="text">Kembali</span>
					...
					<div class="card shadow mb-4">						
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-bold"> Disposisi Surat Masuk #<?= $t['no_suratmasuk'] ?></h6>
						</div>
                                        ...
                                        <div class="modal fade" id="hapus<?php echo $row['id_disposisi']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">Pilih "Hapus" untuk menghapus data disposisi <?= $row['tujuan'] ?>.</div>
