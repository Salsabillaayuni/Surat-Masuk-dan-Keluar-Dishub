...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-cog"></i> Data Bidang</h1>

    <a href="#" data-toggle="modal" data-target="#tambahkla" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data </a>
</div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $row['judul_klasifikasi'] ?></td>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Yakin ingin msenghapus data?</h5>
                            ...
                            <div class="modal-content">
								...
								<div class="modal-body">
									...
									?>                                    
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-warning" type="button" data-dismiss="modal"><i class="fas fa-fw fa-times mr-1"></i> Batal</button>
											<button class="btn btn-primary" type="submit"><i class="fas fa-fw fa-save mr-1"></i> Update</button>
                                        </div>
