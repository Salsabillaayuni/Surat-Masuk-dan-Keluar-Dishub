...
<!-- DataTales Example -->
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-2">
                <img src="assets/img/Dishub.png?= $row['logo'] ?>" alt="<?= $row['logo'] ?>" class="w-100"/>
            </div>
			...
			?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="text" name="namains" required class="form-control" value="<?= $row['institusi'] ?>" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="assets/img/Dishub.png?= $row['logo'] ?>" alt="<?= $row['logo'] ?>" width="80px" />
                            </div>
                        </div>
