...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="#" data-toggle="modal" data-target="#tambahsk" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data </a>
	<?php }?>
</div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">												
												<div class="btn-group" role="group">
													...
													<a title="Detail" href="detail_sk.php?id=<?= $row['id_suratkeluar'] ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kla" class="form-control">
                                    ...
                                    <?php
										...
										{
										?>
                                    <option value="<?=$row['judul_klasifikasi'] ?>">
