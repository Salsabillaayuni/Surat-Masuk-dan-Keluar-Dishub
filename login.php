...
<html lang="en">
    <head>
        ...
        <title>Website Surat Masuk & Keluar</title>
        ...
        <div class="container py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-5 col-md-9">
                    <div class="text-white text-center font-weight-bold" style="font-size: 60px;">    
                    <div class="">
                <img src="assets/img/Dishub.png" width="150px height="150px" /> <br></div>
                    <h3 class="text-white text-center font-weight-bold">Sistem Pendataan Surat Masuk dan Surat Keluar</h3>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <form class="user" action="" method="post">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-user btn-block" name="login">Masuk <i class="fas fa-fw fa-sign-in-alt mr-1"></i> </button>
                                        </form>
                                    </div>
                                </div>
                            </div>
