<?php
    ...
    elseif($_GET['act']=='edit'){
        ...
        if($_FILES['filesm']['name']==''){
            mysqli_query($conn, "UPDATE tb_suratmasuk SET no_suratmasuk='$no', no_agenda='$noag', asal_surat='$asal', judul_klasifikasi='$kla', isi_surat='$isi', tgl_surat='$tglsm', tgl_diterima='$tgld', ket_suratmasuk='$ket', file_suratmasuk='$filelama' WHERE id_suratmasuk='$id'");
            ...
            if(!in_array($ext,$ekstensi) ) {
                ...
                if($ukuran < 5044070){ //5Mb	
                    ...
                    $xx = $rand.'_'.$filename;
                    move_uploaded_file($_FILES['filesm']['tmp_name'], '../file/suratmasuk/'.$rand.'_'.$filename);
                    mysqli_query($conn, "UPDATE tb_suratmasuk SET no_suratmasuk='$no', no_agenda='$noag', asal_surat='$asal', judul_klasifikasi='$kla', isi_surat='$isi', tgl_surat='$tglsm', tgl_diterima='$tgld', ket_suratmasuk='$ket', file_suratmasuk='$xx' WHERE id_suratmasuk='$id'");
                    echo "<script language='javascript'>alert('Berhasil Mengedit data'); document.location.href='../suratmasuk.php';</script>";
                    } else {
                    unlink("../file/suratmasuk/$b[file_suratmasuk]");
                    $xx = $rand.'_'.$filename;
