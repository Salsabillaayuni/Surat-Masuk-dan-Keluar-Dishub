...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold"> Pilih Tanggal Laporan Surat Keluar</h6>
    </div>
    ...
    <form action="" method="POST">
        ...
        <div class="card-footer text-right">
            <button name="lihat" class="btn btn-primary" type="submit"><i class="fas fa-fw fa-check mr-1"></i> Pilih Tanggal</button>
        </div>
    </form>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header card-header py-3">
        <h6 class="m-0 font-weight-bold"> Data Laporan Surat Keluar <?=$tglaw?> s/d <?=$tglak?></h6>
    </div>
