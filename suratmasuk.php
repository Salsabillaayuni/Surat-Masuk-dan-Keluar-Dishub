...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="#" data-toggle="modal" data-target="#tambahsm" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data </a>
	<?php }?>
</div>
									...
									<form action="data/data_sm.php?act=edit" method="POST" enctype="multipart/form-data">
										<div class="modal-body">
											...
											<div class="row">
													...
													<div class="form-group">
														...
														<?php
															if($rowe['file_suratmasuk']=='TIDAK ADA FILE'){
																...
																?>
																<a href="fsm.php?id=<?= $rowe['id_suratmasuk'] ?>" class="btn btn-primary btn-sm">Lihat File</a>
																<?php
															}
														?>
													</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="font-weight-bold">Bidang Surat</label>
														<select name="kla" class="form-control">
														<option value="">--Pilih Bidang--</option>
														<?php
														$tampil=mysqli_query($conn, "SELECT * FROM tb_klasifikasi");
															echo "<option value='$row[judul_klasifikasi]' selected>$row[judul_klasifikasi] - $row[judul_klasifikasi]</option>";
																?>
														?>
														</select>
													</div>
													...
													<div class="form-group">
														...
														<input value="<?= $rowe['tgl_surat'] ?>" type="date" name="tglsm" required class="form-control" value="<?= $rowe['judul_klasifikasi'] ?>" />
													</div>
										...
										<div class="modal-footer">
											<button class="btn btn-warning" type="button" data-dismiss="modal"><i class="fas fa-fw fa-times mr-1"></i> Batal</button>
											<button class="btn btn-primary" type="submit"><i class="fas fa-fw fa-save mr-1"></i> Simpan</button>
										</div>
									</form>
									<?php } ?>
								</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								{
								?>
									<option value="<?=$row['judul_klasifikasi'] ?>"><?= $row['judul_klasifikasi'] ?> - <?= $row['judul_klasifikasi'] ?></option>
